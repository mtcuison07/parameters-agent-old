...
import org.rmj.parameters.Occupation;

/**
 *
 * @author kalyptus
 */
public class XMOccupation implements XMRecord{
   public XMOccupation(GRider foGRider, String fsBranchCd, boolean fbWithParent){
      this.poGRider = foGRider;
      if(foGRider != null){
         this.pbWithParnt = fbWithParent;
         this.psBranchCd = fsBranchCd;
         poCtrl = new Occupation();
   ...
   public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN){
        ...
        if(!(fnCol == poData.getColumn("sOccptnID") ||
   ...
   private UnitOccupation poData;
   private Occupation poCtrl;
