...
import org.rmj.parameters.MCModel;
 ...
 * @author kalyptus
 */
public class XMMCModel implements XMRecord{
   public XMMCModel(GRider foGRider, String fsBranchCd, boolean fbWithParent ){
   ...
   public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN){
        if(!(fnCol == poData.getColumn("sBrandIDx") ||
   ...
   public XMBrand getBrand(){
      if(poBrand == null)
         poBrand = new XMBrand(poGRider, psBranchCd, true);

      poBrand.openRecord(poData.getBrandID());
      return poBrand;
   }

   // Member Variables here
   private boolean pbWithParnt;
   private UnitMCModel poData;
   private MCModel poCtrl;
   private GRider poGRider;
   private int pnEditMode;
   private String psBranchCd;

   private XMBrand poBrand = null;
}
