...
import org.rmj.parameters.Province;
 ...
 * @author kalyptus
 */
public class XMProvince implements XMRecord{
   public XMProvince(GRider foGRider, String fsBranchCd, boolean fbWithParent){
   ...
   public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN){
        ...
        if(!(fnCol == poData.getColumn("sProvIDxx") ||
   ...
   private UnitProvince poData;
   private Province poCtrl;
