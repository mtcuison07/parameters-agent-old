...
import org.rmj.parameters.Barcode;

public class XMBarcode implements XMRecord{
    public XMBarcode(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new Barcode();
    ...
    private Barcode poControl;
    private UnitBarcode poData;
    ...
    private final String pxeModuleName = "XMBarcode";
}
